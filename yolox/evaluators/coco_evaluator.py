    ...
    def evaluate_prediction(self, data_dict, statistics):
        ...
        if len(data_dict) > 0:
            ...
            if "info" not in cocoGt.dataset:
                logger.warning("'info' key not found in cocoGt.dataset. Injecting default info.")
                cocoGt.dataset["info"] = {
                    "description": "Auto-injected for evaluation",
                    "version": "1.0",
                    "year": 2025
                }
            ...
            if self.testdev:
                ...
                try:
                    ...
                    # 修正した一時ファイルを使って再読み込み
                        cocoDt = cocoGt.loadRes(fixed_tmp)
                    else:
                        raise
            try:
